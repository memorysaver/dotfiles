...
## Mission
<!-- What the user was trying to accomplish. Context. Why now. -->

## Prompt Evolution
<!-- Ordered list of how the user's ask shifted across turns.
     Each entry: 1-line prompt summary + 1-line commentary on why it shifted. -->
