...
rule_source="$(DOTFILES_DIR="$D" bash -c 'source "$1/lib/helpers.sh"; source "$1/lib/workspace.sh"; workspace_rule_source' _ "$D")"
check_symlink "$HOME/Work/orchestration-rules" "$rule_source"
